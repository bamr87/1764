...
- `chore: add content instructions and publish-session skill`
...
- Files changed (count)
- Link to the GitHub commit. Derive the base URL from the remote (do not hardcode):
  run `git remote get-url origin`, normalize to `https://github.com/<owner>/<repo>`, and append
  `/commit/<sha>`.
